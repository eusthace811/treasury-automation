...
export class TreasuryContextResolver implements ContextResolver {
  ...
  getAvailableSources(): string[] {
    ...
    const accountFields =
      this.accounts.length > 0 ? this.getNumericFields(this.accounts[0]) : [];
    ...
    if (this.invoices.length > 0) {
      ...
      sources.push(
        ...
        'invoices.approved.amount',
        'invoices.approved.total-amount',
        'invoices.pending.amount',
        'invoices.pending.total-amount',
      );
    }
    ...
    if (this.contractors.length > 0) {
      ...
      sources.push(
        'contractors.total-hourly-rate',
        'contractors.active.total-hourly-rate',
      );
    }
    ...
    if (this.transactions.length > 0) {
      sources.push(
        ...
        'transactions.incoming.total',
        'transactions.outgoing.total',
      );
    }
    ...
    switch (collectionName) {
      ...
      case 'accounts':
        return this.accounts.length > 0
          ? this.getNumericFields(this.accounts[0])
          : [];
      case 'invoices':
        return this.invoices.length > 0
          ? this.getNumericFields(this.invoices[0])
          : [];
      case 'employees':
        return this.employees.length > 0
          ? this.getNumericFields(this.employees[0])
          : [];
      case 'contractors':
        return this.contractors.length > 0
          ? this.getNumericFields(this.contractors[0])
          : [];
      case 'transactions':
        return this.transactions.length > 0
          ? this.getNumericFields(this.transactions[0])
          : [];
      default:
        return [];
    }
   ...
   */
  private resolveContractorsField(
    fieldPath: string[],
    context?: Record<string, any>,
  ): number | null {
    if (fieldPath.length === 0) return null;
   ...
   */
  private resolveTransactionsField(
    fieldPath: string[],
    context?: Record<string, any>,
  ): number | null {
    if (fieldPath.length === 0) return null;
   ...
   */
  private resolveSpecificAccount(
    fieldPath: string[],
    context?: Record<string, any>,
  ): number | null {
   ...
   */
  private resolveSpecificInvoice(
    fieldPath: string[],
    context?: Record<string, any>,
  ): number | null {
    if (fieldPath.length === 0) return null;
    ...
    const approvedInvoice = this.invoices.find(
   ...
   */
  private resolveSpecificEmployee(
    fieldPath: string[],
    context?: Record<string, any>,
  ): number | null {
    if (fieldPath.length === 0) return null;
   ...
   */
  private resolveSpecificContractor(
    fieldPath: string[],
    context?: Record<string, any>,
  ): number | null {
    if (fieldPath.length === 0) return null;
   ...
   */
  private resolveSpecificTransaction(
    fieldPath: string[],
    context?: Record<string, any>,
  ): number | null {
    if (fieldPath.length === 0) return null;
